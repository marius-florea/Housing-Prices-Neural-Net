...
def get_autoencoder(input_size=65):
    encoding_dim = 32
...
autoencoder = get_autoencoder(len(my_cols_with_saleprice))
...
autoencoder.fit(mat_train_scaled, mat_train_scaled, epochs=1000, batch_size=100, shuffle=True,validation_data=(mat_train_scaled,mat_train_scaled))
...
prediction_df.to_csv("syntetic_data_from_ae_2.csv", index_label='Id')
